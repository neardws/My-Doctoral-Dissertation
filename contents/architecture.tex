\chapter[\hspace{0pt}基于分层车联网架构的车载信息物理融合系统建模]{{\CJKfontspec{SimHei}\zihao{3}\hspace{-5pt}基于分层车联网架构的车载信息物理融合系统建模}}
\removelofgap
\removelotgap
...
\section[\hspace{-2pt}引言]{{\CJKfontspec{SimHei}\zihao{-3} \hspace{-8pt}引言}}\label{section 2-1}
...
\section[\hspace{-2pt}分层车联网架构设计]{{\CJKfontspec{SimHei}\zihao{-3} \hspace{-8pt}分层车联网架构设计}}\label{section 2-2}
