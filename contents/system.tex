\chapter[超视距碰撞预警原型系统设计及实现]{超视距碰撞预警原型系统设计及实现}
\removelofgap
\removelotgap
...
\begin{figure}[h]
\centering
  \includegraphics[width=0.85\columnwidth]{Fig5-10-delays.pdf}
...
\begin{figure}[h] 
	\centering
	\includegraphics[width=1\columnwidth]{Fig5-12-1.pdf}
...
\begin{figure}[h] 
	\centering
	\includegraphics[width=1\columnwidth]{Fig5-12-2.pdf}
